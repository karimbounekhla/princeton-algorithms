...
/**
 * 2d-tree implementation; a generalization of a BST to two-dimensional keys, i.e. with 
 * points in the nodes, using the x- and y-coordinates of the points as
...
public class KdTree {
    ...
    /**
     * Recursivly search left/bottom right/top if it could contain a closer point
     */
